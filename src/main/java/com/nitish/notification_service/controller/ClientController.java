...
public class ClientController {
    ...
    @PatchMapping(path = "/clients/{clientId}/status", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PatchMapping(path = "/clients/{clientId}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
